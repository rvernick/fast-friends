    ...
    try {
      for (const item of selectedItems) {
        if (await this.updateOrAddMaintenanceItem(
          ...
          item.maintenanceItem.defaultLongevity > 0 ? item.maintenanceItem.dueDistanceMeters : 0,
          item.maintenanceItem.defaultLongevityDays > 0 ? item.maintenanceItem.dueDate : null,
          "", // brand,
          "", // model,
          "", // link,
