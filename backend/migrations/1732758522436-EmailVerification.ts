...
export class EmailVerification1732758522436 implements MigrationInterface {
    name = 'EmailVerification1732758522436'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "email_verify" ("id" SERIAL NOT NULL, "token" character varying NOT NULL, "expires_on" TIMESTAMP NOT NULL, "deleted_on" TIMESTAMP, "created_on" TIMESTAMP NOT NULL DEFAULT now(), "updated_on" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer NOT NULL, CONSTRAINT "PK_58749aeaa40bfafb1debe261ca0" PRIMARY KEY ("id"))`);
